      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			...
			<tr>
			<td rowspan="3"></td>
			<th><font color="#FFFFFF"><strong><h4>(( HRD ))</strong></font></h4>
			</th>
      ...
      <div style="background:url(../images/0.png)repeat;" class="content-wrapper">
        ...
        <section  class="content-header">
          <h1> Sistem Kepegawaian
            <small>Dinas Perhubungan Kota Pagar Alam</small>
          </h1>
          <ol class="breadcrumb">
	...
	<?php include "isi.php";?>        		
       ...
       <footer class="main-footer">
        <div class="pull-right hidden-xs">
          Sistem Kepegawaian <b>Version</b> 1.0
        </div>
        <strong>Copyright &copy; 2020 <a href="#">Programmer</a>.</strong> STT Pagaralam.
